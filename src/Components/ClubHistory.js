...
export const ClubHistory = () => {
  ...
  useEffect(() => {
    oReq.onload = function (e) {
      ...
      const filteredResults2 = filteredResults.map(
        ({ __EMPTY_2, __EMPTY_3 }) => ({ __EMPTY_2, __EMPTY_3 }),
      );
      ...
      const parsedData2022 = XLSX.utils.sheet_to_json(worksheet2022, {
        raw: true,
      });

      const filteredResult2022 = parsedData2022.slice(39, 49);

      const filteredResults2022 = filteredResult2022.map(
        ({ __EMPTY_2, __EMPTY_3 }) => ({ __EMPTY_2, __EMPTY_3 }),
      );
      ...
      const totalWinnings2022 = totalWinning2022.map(
        ({ __EMPTY_2, __EMPTY_3 }) => ({ __EMPTY_2, __EMPTY_3 }),
      );
  ...
  return (
    <div className="ClubHistory-div">
      ...
      <div className="seasonsContainer">
        <div className="seasonsDiv" id="div2025">
          <h2 className="text-subheader">2025 Season</h2>
          <p>
            <p className="HistoryTitle">First:</p> Scott Bamford
          </p>
          <p>
            <p className="HistoryTitle">Second:</p> Brenton Jaskola
          </p>
          <p>
            <p className="HistoryTitle">Third:</p> Paul Blakey
          </p>
          <p>
            <p className="HistoryTitle">Toilet:</p> Chris Pano
          </p>
        </div>
        <div className="seasonsDiv" id="div2024">
          ...
          <p>
            <p className="HistoryTitle">Second:</p> Paul Blakey
          </p>
          <p>
            <p className="HistoryTitle">Third:</p> Daniel Milevski
          </p>
          <p>
            <p className="HistoryTitle">Toilet:</p> Simon Capozzi
          </p>
        </div>
        <div className="seasonsDiv" id="div2023">
          <h2 className="text-subheader">2023 Season</h2>
          <p>
            <p className="HistoryTitle">First:</p> Brendan Spicer
          </p>
          <p>
            <p className="HistoryTitle">Second:</p> Daniel Milevski
          </p>
          <p>
            <p className="HistoryTitle">Third:</p> Simon Capozzi
          </p>
          <p>
            <p className="HistoryTitle">Toilet:</p> Kane Hornsey
          </p>
        </div>
        <div className="seasonsDiv" id="div2022">
          <h2 className="text-subheader">2022 Season</h2>
          <p>
            <p className="HistoryTitle">First:</p> Paul Blakey
          </p>
          <p>
            <p className="HistoryTitle">Second:</p> Brenton Jaskola
          </p>
          <p>
            <p className="HistoryTitle">Third:</p> Brenton Turnor
          </p>
          <p>
            <p className="HistoryTitle">Toilet:</p> Brendan Spicer & Scott
            Bamford
          </p>
        </div>
        <div className="seasonsDiv" id="div2021">
          ...
          <p>
            <p className="HistoryTitle">Toilet:</p> Brendan Spicer & Beau
            Raffaele
          </p>
        </div>
        <div className="seasonsDiv" id="div2020">
          ...
          <p>
            <p className="HistoryTitle">First:</p> Brenton Turnor
          </p>
          <p>
            <p className="HistoryTitle">Second:</p> Brendan Spicer
          </p>
          <p>
            <p className="HistoryTitle">Third:</p> Scott Bamford
          </p>
          <p>
            <p className="HistoryTitle">Toilet:</p> Kane Hornsey & Daniel
            Milevski
          </p>
        </div>
        <div className="seasonsDiv" id="div2019">
          ...
          <p>
            <p className="HistoryTitle">First:</p> Beau Raffaele
          </p>
          <p>
            <p className="HistoryTitle">Second:</p> Daniel Milevski
          </p>
          ...
          <p>
            <p className="HistoryTitle">Toilet:</p> No Record
          </p>
        </div>
        <div className="seasonsDiv" id="div2018">
          ...
          <p>
            <p className="HistoryTitle">Second:</p> No Record
          </p>
          <p>
            <p className="HistoryTitle">Third:</p> No Record
          </p>
          <p>
            <p className="HistoryTitle">Toilet:</p> No Record
          </p>
